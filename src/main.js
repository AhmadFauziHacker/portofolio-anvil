...
const projectsData = {
    skyline: {
        ...
        image: "./public/projek/1755095716544.jpeg",
    ...
    nova: {
        ...
        image: "./public/projek/1755017925946.jpeg",
    ...
    zenith: {
        ...
        image: "./public/projek/inspirasa 2.jpeg",
        ...
        <div class="flex flex-col md:flex-row h-full">
            ...
            <div class="w-full md:w-1/2 p-8 md:p-12 overflow-y-auto">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <h4 class="font-bold mb-3 dark:text-white">Overview:</h4>
